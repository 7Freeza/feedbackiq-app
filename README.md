...
| Capa | Stack |
|------|--------|
| Frontend | Vanilla JS, Vite 6, Chart.js — diseño **Vacío numérico** |
| Backend | FastAPI, uvicorn, thread pool + jobs async |
...
│   ├── app/
│   │   ├── api/          # Rutas HTTP
│   │   ├── core/         # Pipeline, CT2, Excel, jobs, analytics
...
├── frontend/
│   ├── css/              # Vacío numérico
│   ├── js/               # Router, API client, charts, views
...
<p align="center">
  <sub>FeedbackIQ · precisión de tokens · traducción local · analítica de ahorro</sub>
</p>
